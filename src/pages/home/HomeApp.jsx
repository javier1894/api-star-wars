...
export const HomeApp = () => {
    ...
    return (
        <div className='overflow-hidden'>
            {!isVisible &&
                <section className="md:max-w-[600px] lg:max-w-[1080px] h-[800px] starWarsText text-[#FFC500] mx-auto text-center px-10 md:px-16 lg:px-20 ">
                    <h2 className='pb-5 md:pb-10 lg:pb-20 text-xl md:text-3xl lg:text-6xl font-bold'>Star Wars App</h2>
                    <p className='text-base md:text-xl lg:text-3xl leading-relaxed mb-5 md:mb-10 lg:mb-20 text-pretty'>
            ...
            {isVisible && <section className='mx-auto flex flex-col justify-center items-center h-[800px]'>
